...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 11 déc. 2024 à 09:30
...
(0, 'Amine', 'Ca va'),
(0, 'Karim', 'Allo'),
(0, 'Anass', 'Salut les Amis !'),
(0, 'Tarik', 'Bonjour tout le monde !'),
(0, 'Hamid', 'J\'ai besoin d\'un cours PHP'),
(0, 'Amal', 'Consultez : https://openclassrooms.com/'),
(0, 'Ali', 'Bonsoir'),
(0, 'Sara', 'Bonjour'),
(0, 'Samir', 'salut'),
(0, 'Amine', 'Salam'),
